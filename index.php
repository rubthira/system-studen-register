...
?>
  ...
  <h1 style="text-align: center; font-weight:bold;">STUDENT DETAILS</h1>
...
<div class="form-group col-md-6">
<label for="aadharno">NDP</label>
<input type="text" class="form-control" name="user_aadhar" maxlength="12" placeholder=" ">
</div>
</div>
...
<div class="form-group">
<label for="inputAddress">IC.NUMBER</label>
<input type="text" class="form-control" name="staff_id" maxlength="12" placeholder="Enter 12-digit">
</div>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
		...
		<div class='form-group col-md-6'>
		<label for='aadharno'>NDP</label>
		<input type='text' class='form-control' name='user_aadhar' maxlength='12' placeholder='' value='$aadhar'>
		</div>
		</div>
		...
		<div class='form-group'>
		<label for='inputAddress'>IC.NUMBER</label>
		<input type='text' class='form-control' name='staff_id' maxlength='12' placeholder='Enter 12-digit' value='$staffCard'>
		</div>
